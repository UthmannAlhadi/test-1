<x-guest-layout>
  <form method="POST" action="{{ route('register') }}">
    ...
    <div class="relative overflow-hidden">
      <div class="mx-auto max-w-screen-md py-12 px-4 sm:px-6 md:max-w-screen-xl md:py-20 lg:py-32 md:px-8">
        <div class="md:pe-8 md:w-1/2 xl:pe-0 xl:w-5/12">
          ...
          <h1
            ...
            Ziegers Printing <span class="text-blue-600 dark:text-blue-300 lg:text-2xl">System</span>
          </h1>
      ...
      <!-- display image -->
      <div
        class="hidden md:block md:absolute md:top-0 md:start-1/2 md:end-0 w-full h-1/3 bg-no-repeat bg-center bg-cover">
        <img src="{{ asset('img/register.jpg') }}" alt="Login Image">
      </div>
      <!-- End Col -->
    </div>
    <!-- End Hero --> --}}
          ...
          <div class="flex-1">
            ...
            <div class="text-center">
              <div class="flex justify-center mx-auto">
                <svg version="1.1" id="Layer_1" class="w-auto h-9 sm:h-10" xmlns="http://www.w3.org/2000/svg" x="0"
                  ...
                  <path
                    d="M0 216v40.998C0 273.015 12.985 286 29.002 286h453.996C499.016 286 512 273.015 512 256.998V216H0z"
                    style="fill:#d476e2" />
                  <path style="fill:#b665c2" d="M95 216h322v70H95z" />
                  <path
                    d="M378.5 261h-245c-5.523 0-10-4.477-10-10s4.477-10 10-10h245c5.523 0 10 4.477 10 10s-4.477 10-10 10z"
                    style="fill:#339" />
              ...
              <p class="mt-3 text-gray-500 dark:text-gray-300">Register your account now</p>
            </div>
              ...
              <form>
                ...
                <div class="mt-2">
                  <x-input-label for="name" :value="__('Name')"
                    class="block text-sm font-medium dark:text-white"><span class="sr-only">Name</span></x-input-label>
                  <x-text-input id="name"
                    class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                    type="text" name="name" :value="old('name')" required autofocus autocomplete="name"
                    placeholder="Name" />
                ...
                <div class="mt-2">
                  <x-input-label for="email" :value="__('Email')"
                    class="block text-sm font-medium dark:text-white"><span class="sr-only">Email
                      address</span></x-input-label>
                  <x-text-input id="email"
                    class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                    placeholder="Email address" type="email" name="email" :value="old('email')" required
                ...
                <div class="mt-2">
                  <x-input-label for="password" :value="__('Password')"
                    class="block text-sm font-medium dark:text-white"><span
                      class="sr-only">Password</span></x-input-label>
                  <x-text-input id="password"
                    class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                    placeholder="Password" type="password" name="password" required autocomplete="new-password"
